...
type DebtServiceClient interface {
	CreateDebt(ctx context.Context, in *CreateDebtReq, opts ...grpc.CallOption) (*Resp, error)
	UpdateDebt(ctx context.Context, in *UpdateDebtReq, opts ...grpc.CallOption) (*Resp, error)
	DeleteDebt(ctx context.Context, in *DeleteDebtReq, opts ...grpc.CallOption) (*Resp, error)
	GetDebtById(ctx context.Context, in *GetDebtByIdReq, opts ...grpc.CallOption) (*Resp, error)
...
func (c *debtServiceClient) CreateDebt(ctx context.Context, in *CreateDebtReq, opts ...grpc.CallOption) (*Resp, error) {
...
func (c *debtServiceClient) UpdateDebt(ctx context.Context, in *UpdateDebtReq, opts ...grpc.CallOption) (*Resp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Resp)
...
func (c *debtServiceClient) DeleteDebt(ctx context.Context, in *DeleteDebtReq, opts ...grpc.CallOption) (*Resp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Resp)
...
func (c *debtServiceClient) GetDebtById(ctx context.Context, in *GetDebtByIdReq, opts ...grpc.CallOption) (*Resp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Resp)
...
type DebtServiceServer interface {
	CreateDebt(context.Context, *CreateDebtReq) (*Resp, error)
	UpdateDebt(context.Context, *UpdateDebtReq) (*Resp, error)
	DeleteDebt(context.Context, *DeleteDebtReq) (*Resp, error)
	GetDebtById(context.Context, *GetDebtByIdReq) (*Resp, error)
...
func (UnimplementedDebtServiceServer) CreateDebt(context.Context, *CreateDebtReq) (*Resp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDebt not implemented")
}
func (UnimplementedDebtServiceServer) UpdateDebt(context.Context, *UpdateDebtReq) (*Resp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDebt not implemented")
}
func (UnimplementedDebtServiceServer) DeleteDebt(context.Context, *DeleteDebtReq) (*Resp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteDebt not implemented")
}
func (UnimplementedDebtServiceServer) GetDebtById(context.Context, *GetDebtByIdReq) (*Resp, error) {
